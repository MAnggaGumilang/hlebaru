    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Control Video</li>
      </ol>
             ...
             <div class="row">
              ...
              <div class="box-header with-border">
                ...
                <div class="box-body d-progress">
                 <iframe width="560" height="315" src="https://www.youtube.com/embed/sFHcHBiW_u0" frameborder="0" allowfullscreen=""></iframe>
                </div>
                <div class="box-footer">
                    <textarea> </textarea>
