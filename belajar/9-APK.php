      ...
      <div class="modal-body">
        <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-number">Jawabanmu Tepat!</span>
              <p>Kamu dapat melanjutkan ke materi yang berikutnya dengan memilih strategi belajar yang kamu pilih...</p>
            </div>
            <!-- /.info-box-content -->
          </div>
          <a href="10-set_strategy.php" class="btn btn-primary btn-block"> Lanjutkan belajar </a>
      </div>
    </div>
  </div>
</div>
<!-- end modal 1 -->
  <!-- Modal 1 -->
<div class="modal fade" id="modal-salah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-lg">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-number">Oops.. sepertinya kamu belum memahai materi sebelumnya</span>
              <p>Sistem menyarankan kamu untuk kembali mempelajari materi sebelumnya, agar kamu dapat mempunyai pemahaman yang cukup untuk mempelajari materi ini.</p>
            </div>
            <!-- /.info-box-content -->
          </div>
          <a href="8-set_goal.php" class="btn btn-success btn-block"> Ambil Materi Sebelumnya </a>
          <a href="10-set_strategy.php" class="btn btn-warning btn-block"> Tetap ambil materi ini </a>
      </div>
    </div>
  </div>
</div>
      ...
      <!--------------------------
        ...
        <div class="callout callout-info">
          <div class="row">
            ...
            <div class="col-lg-11">
            <h3>Pilihan materi yang bagus, saatnya melakukan <i>Activation Prior Knowledge</i> (APK)</h3>
            <p>APK merupakan pre-test sebelum kamu lanjut pada materi berikutnya.. Akan disajikan sebuah pertanyaan dari sebelumnya, dan kamu harus menjawab dengan uraian singkat <i>(short-essay)</i></p>
            <div class="btn-group">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-benar">Jawaban Benar</button>
                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-salah">Jawaban Salah</button>
            </div>
            </div>
        </div>
      </div>
      ...
      <h4> Self-Evaluation </h4>
          ...
          <div class="row">
            <div class="box box-primary">
              <div class="box-header with-border">
                  <h3 class="box-title"> Pertanyaan: Tulislah definisi dari sebuah tree.. </h3>
                </div>
                <div class="box-body">
                 <textarea></textarea>
                </div>
                <div class="box-footer" style="text-align: right">
                    <a href="#" class="btn btn-primary"> <i class="fa fa-floppy-o"></i> Submit </a>
                </div>
            </div>
          </div>
    </section>
