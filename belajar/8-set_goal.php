      ...
      <!--------------------------
        ...
        <div class="callout callout-info">
          <div class="row">
            ...
            <div class="col-lg-11">
            <h3>Saatnya Mulai Pembelajaran Baru!</h3>
            <p>Di bawah ini merupakan list Materi yang belum kamu ambil. Silahkan pilih salah satu kartu materi yang ingin anda pelajari!</p>
            </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="box-body d-progress">
                 <img src="../Assets/img/tree.png" class="img-circle" width="100px">
                ...
                <a href="#" class="btn btn-block btn-primary"> ambil materi </a>
                </div>
              </div>
            </div>
            <div class="col-md-6">
               <div class="box box-primary">
                ...
                <div class="box-body d-progress">
                 <img src="../Assets/img/sort.png" class="img-circle" width="100px">
                   <p> If the sort key values are totally ordered, the sort key defines a weak order of the items: items with the same sort key are equivalent with respect to sorting. See also stable sorting. If different items have different sort key values then this defines a unique order of the items. </p>
                <a href="9-APK.php" class="btn btn-block btn-primary"> ambil materi </a>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
               <div class="box box-primary">
                ...
                <div class="box-body d-progress">
                 <img src="../Assets/img/search.png" class="img-circle" width="100px">
                    <p> Search algorithms can be classified based on their mechanism of searching. Linear search algorithms check every record for the one associated with a target key in a linear fashion. </p>
                <a href="#" class="btn btn-block btn-primary"> ambil materi </a>
                </div>
              </div>
            </div>
            <div class="col-md-6">
               <div class="box box-primary">
                ...
                <div class="box-body d-progress">
                 <img src="../Assets/img/graph.png" class="img-circle" width="100px">
                 <p> A graph data structure consists of a finite (and possibly mutable) set of vertices or nodes or points, together with a set of unordered pairs of these vertices for an undirected graph or a set of ordered pairs for a directed graph.  </p>
                <a href="#" class="btn btn-block btn-primary"> ambil materi </a>
                </div>
              </div>
            </div>
