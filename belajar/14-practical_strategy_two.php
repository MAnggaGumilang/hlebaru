    ...
    <div class="status">
      <h4> Self-Evaluation </h4>
          ...
          <div class="row">
            ...
            <p>Pada langkah Kedua Mahasiswa Diminta Mengisi Tabel Desk Checking berdasarkan Urutan Psedocode yang telah ditentukan sebelumnya. </p>
            </div>
        </div>
      </div>
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">Desk Checking Table</h3>
        </div>
        <div class="box-body">
          <table class="table table-bordered">
                <tr>
                  <th width="10%">Iterasi</th>
                  <th width="30%">X</th>
                  <th width="30%">Y</th>
                  <th width="30%">Z</th>
                </tr>
