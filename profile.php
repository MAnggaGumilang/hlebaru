...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="profile.php"><i class="fa fa-gear"></i> <span>Profile</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <li class="active"><a href="#control-sidebar-home-tab" data-toggle="tab">User Profile</a></li>
      <li><a href="#control-sidebar-settings-tab" data-toggle="tab">Password</a></li>
      </ul>
      <ol class="breadcrumb">
        ...
        <section class="content">
          <div class="row">
            <div class="col-lg-4" style="text-align: center;">
                ...
                <hr/>
                  <img  src="Assets/img/user2-160x160.jpg" width="75%" class="img-circle">
                  <a href="#" class="btn btn-default btn-md btn-block" id="falseinput">Select Images</a>
            ...
            <div class="col-lg-8">
              ...
              <hr/>
              <hr/>
              <label> Name <input type="text" placeholder="Budi Hivi" /> </label>
              <label> Email <input type="email" placeholder="Budi@um.ac.id" /> </label>
              <label> Whatsapp Number <input type="text" placeholder="+628123456" /> </label>
            </div>
            <div class="col-lg-8"> </div>
            <div class="col-lg-4">
                <a href="#" class="btn btn-success btn-lg btn-block">Update Profile</a>
            </div>
            </div>
        ...
        <section class="content">
           <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <a href="#" class="btn btn-success btn-lg btn-block"> CHANGE </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
